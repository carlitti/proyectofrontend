...
const ProductDetail = () => {
    ...
    return (
        <div className="container mt-5">
            ...
            <img src={producto.imagen || "https://via.placeholder.com/400"} alt={producto.titulo} className="img-fluid" />
            <p><strong>Precio:</strong> ${producto.precio}</p>
            <p><strong>Publicado por:</strong> {producto.usuario || "Anónimo"}</p>
            ...
            <div className="contact-seller mt-4">
                ...
                <form onSubmit={handleSendMessage}>
                    <textarea className="form-control" rows="3" placeholder="Escribe tu mensaje aquí..."
